            ...
            <div className="flex-1 p-12 bg-white">
                <Square>
                    <div className="bg-[#ffffff] p-6 h-full rounded-lg">
                        <h1 className="flex flex-col items-center text-4xl text-black mt-6 font-semibold">Ubah Kata Sandi</h1>
                        <h3 className="flex flex-col items-center text-lg text-[#1694F6] font-regular mt-7 mb-8">
                            Silakan masukkan email dan nomor telepon Anda untuk mengubah kata sandi
                        </h3>
                        <InputBar 
                            label="Nomor Telepon"
                            type="number"
