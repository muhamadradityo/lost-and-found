...
const Step1 = ({ nextStep, handleChange, values }) => {
    ...
    return (
        <div className="bg-white rounded-lg py-14 px-32 flex flex-col justify-center">
            <h1 className='text-[40px] text-center'>Informasi Data Barang Ditemukan</h1>
            <h2 className='text-[#1694F6] mt-5 text-center'>Isi data - data informasi barang yang ditemukan agar dapat diklaim pemilik.</h2>
            <form action="#" className='w-full grid grid-cols-2 gap-9 mt-7' encType='multipart/form-data'>
                <div className='flex flex-col space-y-3'>
                    <label htmlFor="Tipe Barang" className='text-[#1694F6]'>Nama Barang</label>
                ...
                <div className='flex flex-col space-y-3'>
                    <label htmlFor="Tanggal Ditemukan" className='text-[#1694F6]'>Tanggal Ditemukan</label>
                    <input className='bg-white p-4 rounded-lg shadow-gray-500 shadow-sm' type="date" name='tanggalDitemukan' style={{ colorScheme: 'normal' }} onChange={handleChange("tanggalDitemukan")} />
                </div>
                <div className='flex flex-col space-y-3'>
                    <label htmlFor="Jam Ditemukan" className='text-[#1694F6]'>Jam Ditemukan</label>
                    <input className='bg-white p-4 rounded-lg shadow-gray-500 shadow-sm' type="time" name='jamDitemukan' style={{ colorScheme: 'normal' }} onChange={handleChange("jamDitemukan")} />
                </div>
