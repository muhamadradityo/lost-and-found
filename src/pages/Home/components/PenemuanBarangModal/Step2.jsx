...
const Step2 = ({ prevStep, nextStep, handleChange, values }) => {
    ...
    return (
        <div className="bg-white rounded-lg py-14 px-32 flex flex-col justify-center">
            <h1 className='text-[40px] text-center'>Informasi Lokasi Barang Ditemukan</h1>
            <h2 className='text-[#1694F6] mt-5 text-center'>Isi informasi lokasi barang yang ditemukan agar dapat divalidasi oleh pemilik.</h2>
            <form action="#" className='w-full grid grid-cols-2 gap-9 mt-7' encType='multipart/form-data'>
                <div className='flex flex-col space-y-3'>
                    <label htmlFor="Lokasi Kehilangan" className='text-[#1694F6]'>Label Lokasi</label>
